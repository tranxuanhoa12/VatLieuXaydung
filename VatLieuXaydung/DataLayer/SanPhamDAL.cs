...
namespace VatLieuXaydung.DataLayer
{
    class SanPhamDAL
    {
        ...
        public bool Insert(SanPham sp, Gia g)
        {
        ...
        public bool Update(SanPham sp, Gia g)
        {
            string spName = "SP_UpdateSanPham";
            string[] pNames = { "@SanPhamID", "@KhuVucID", "@DonViTinhID", "@LoaiHangID", "@HangSanXuat", "@Model", "@DiemGiaoHang", "@ThongSoKhac", "@GiaID", "@NguonGia", "@Gia", "@ThoiDiem", "@DonViTinhGiaID", "@VAT", };
            object[] pValues = { sp.SanPhamID, sp.KhucVucID, sp.DonViTinhID, sp.LoaiHangID, sp.HangSanXuat, sp.Model, sp.DiemGiaoHang, sp.ThongSoKhac, g.GiaID, g.NguonGia, g.Gia1, g.Thoidiem, g.DvtGiaID, g.VAT1 };
